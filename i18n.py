...
_TRANSLATIONS = {
    "en_US": {
        ...
        "panel.node_manual": "Node Manual",
        "button.node_read": "Read",
        "button.node_apply": "Apply",
        "button.node_edit": "Edit in Editor",
        "label.deep_thinking": "Deep Thinking",
        "button.ai_adjust_node": "AI Adjust",
        "button.ai_adjusting_node": "Adjusting...",
        "message.node_tree_read": "Node tree read",
        "message.node_tree_empty": "Node tree is empty",
        "message.node_no_tree": "No node tree found",
        "message.node_invalid_json": "Invalid JSON format",
        "message.node_applied": "Changes applied",
    ...
    "zh_CN": {
        ...
        "panel.node_manual": "节点手动编辑",
        "button.node_read": "读取",
        "button.node_apply": "应用",
        "button.node_edit": "编辑器编辑",
        "label.deep_thinking": "深度思考",
        "button.ai_adjust_node": "AI调整",
        "button.ai_adjusting_node": "调整中...",
        "message.node_tree_read": "节点树已读取",
        "message.node_tree_empty": "节点树为空",
        "message.node_no_tree": "未找到节点树",
        "message.node_invalid_json": "JSON格式错误",
        "message.node_applied": "已应用更改",
        "prefs.language": "语言",
